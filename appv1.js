...
//declare video
// app.js
const { playLoop } = require('./vlcController');
// Start looping video1
  ...
  try {
    ...
    if (statusFlag === 0) {
      if (hasData) {
        ...
        playLoop('file:///C:/Users/User/Documents/VIDEO/video2.mov');

      } else {
        console.log("do action 1");
        playLoop('file:///C:/Users/User/Documents/VIDEO/video1.mp4');
